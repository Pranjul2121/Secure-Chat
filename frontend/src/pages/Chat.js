...
@keyframes featureCardIn { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }
...
const Icons = {
  ...
  Lock: () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>,
  Shield: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg>,
...
const s = {
  ...
  encBadge: { display: "flex", alignItems: "center", gap: "6px", background: "rgba(34, 197, 94, 0.08)", border: "1px solid rgba(34, 197, 94, 0.2)", borderRadius: "8px", padding: "5px 10px", marginBottom: "12px", fontSize: "11px", color: "#86efac", fontWeight: "600" },
  ...
  userListHeader: { padding: "8px 14px 6px", fontSize: "11px", fontWeight: "700", color: "rgba(255,255,255,0.35)", textTransform: "uppercase", letterSpacing: "1px" },
  userItem: { padding: "12px 14px", cursor: "pointer", borderRadius: "14px", display: "flex", alignItems: "center", gap: "12px", marginBottom: "4px", background: "rgba(255, 255, 255, 0.03)", border: "1px solid transparent", transition: "all 0.3s ease" },
  userItemActive: { padding: "12px 14px", cursor: "pointer", borderRadius: "14px", display: "flex", alignItems: "center", gap: "12px", marginBottom: "4px", background: "linear-gradient(135deg, rgba(139, 92, 246, 0.15), rgba(236, 72, 153, 0.15))", border: "1px solid rgba(139, 92, 246, 0.3)", boxShadow: "0 4px 20px rgba(139, 92, 246, 0.2)" },
  avatar: { width: "46px", height: "46px", borderRadius: "14px", background: "linear-gradient(135deg, #8b5cf6, #ec4899)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "18px", color: "#fff", flexShrink: 0, boxShadow: "0 4px 15px rgba(139, 92, 246, 0.3)", position: "relative" },
  avatarOnlineDot: { position: "absolute", bottom: "-2px", right: "-2px", width: "12px", height: "12px", borderRadius: "50%", backgroundColor: "#22c55e", border: "2px solid #1a1a2e", animation: "onlinePulse 2s ease-in-out infinite" },
  userMeta: { flex: 1, minWidth: 0 },
  userName: { fontWeight: "600", fontSize: "14px", color: "#e9edef", marginBottom: "2px" },
  userLastMsg: { fontSize: "12px", color: "rgba(255,255,255,0.45)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
  unreadBadge: { background: "linear-gradient(135deg, #8b5cf6, #ec4899)", borderRadius: "10px", padding: "2px 7px", fontSize: "11px", fontWeight: "700", color: "#fff", flexShrink: 0 },
  ...
  chatHeaderSub: { fontSize: "12px", color: "#22c55e", display: "flex", alignItems: "center", gap: "4px", marginTop: "2px" },
  chatHeaderSubOffline: { fontSize: "12px", color: "rgba(255,255,255,0.4)", marginTop: "2px" },
  encBadgeSmall: { display: "flex", alignItems: "center", gap: "4px", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.2)", borderRadius: "6px", padding: "3px 8px", fontSize: "10px", color: "#86efac", fontWeight: "600" },
  ...
  messages: {
    flex: 1, overflowY: "auto", padding: "24px", display: "flex", flexDirection: "column", gap: "4px",
  ...
  msgWrapper: (mine) => ({ display: "flex", flexDirection: "column", alignItems: mine ? "flex-end" : "flex-start", marginBottom: "2px" }),
  msgSender: { fontSize: "11px", color: "#c4b5fd", fontWeight: "600", marginBottom: "3px", marginLeft: "14px" },
  msgSent: { alignSelf: "flex-end", background: "linear-gradient(135deg, #8b5cf6, #7c3aed)", padding: "10px 14px 6px", borderRadius: "18px 4px 18px 18px", maxWidth: "65%", fontSize: "14px", lineHeight: "1.6", boxShadow: "0 4px 15px rgba(139, 92, 246, 0.3)", animation: "messagePop 0.4s ease forwards" },
  msgReceived: { alignSelf: "flex-start", background: "rgba(255, 255, 255, 0.1)", backdropFilter: "blur(10px)", border: "1px solid rgba(255, 255, 255, 0.1)", padding: "10px 14px 6px", borderRadius: "4px 18px 18px 18px", maxWidth: "65%", fontSize: "14px", lineHeight: "1.6", animation: "messagePop 0.4s ease forwards" },
  msgSticker: { fontSize: "48px", padding: "8px", background: "transparent", border: "none", boxShadow: "none" },
  msgMeta: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "4px", marginTop: "4px" },
  msgTime: { fontSize: "10px", color: "rgba(255, 255, 255, 0.45)" },
  msgTicks: { fontSize: "10px", color: "rgba(255,255,255,0.5)", display: "flex", alignItems: "center" },
  msgTicksDelivered: { fontSize: "10px", color: "#67e8f9", display: "flex", alignItems: "center" },

  // Date separator
  dateSeparator: { display: "flex", alignItems: "center", gap: "12px", margin: "16px 0 8px" },
  dateLine: { flex: 1, height: "1px", background: "rgba(255,255,255,0.08)" },
  dateText: { fontSize: "11px", color: "rgba(255,255,255,0.35)", fontWeight: "600", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "10px", padding: "3px 10px" },

  // Empty chat state
  emptyChat: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, padding: "32px 24px", gap: "8px" },
  emptyChatIcon: { fontSize: "52px", animation: "floatIcon 3s ease-in-out infinite", marginBottom: "8px" },
  emptyChatTitle: { fontSize: "18px", fontWeight: "700", background: "linear-gradient(135deg, #8b5cf6, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", textAlign: "center" },
  emptyChatSub: { fontSize: "13px", color: "rgba(255,255,255,0.4)", textAlign: "center" },
...
// ── NoChat info panel ──────────────────────────────────────
const NoChat = ({ onlineCount }) => {
  const features = [
    { icon: "🔒", label: "End-to-End Encrypted", color: "#22c55e", desc: "Messages sirf tum aur receiver dekh sakte ho" },
    { icon: "🪪", label: "Face-Protected Login", color: "#8b5cf6", desc: "AI biometric authentication" },
    { icon: "📲", label: "QR Code Login", color: "#06b6d4", desc: "Web pe bina password ke login" },
    { icon: "🛡️", label: "AI Threat Detection", color: "#f59e0b", desc: "Spoof attacks automatically blocked" },
    { icon: "💬", label: "Real-time Messaging", color: "#ec4899", desc: "Instant WebSocket messaging" },
    { icon: "🎙️", label: "Voice to Text", color: "#10b981", desc: "Hindi voice input support" },
  ];
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 40px", backgroundColor: "rgba(10, 15, 25, 0.5)", backgroundImage: `radial-gradient(rgba(255, 255, 255, 0.03) 2px, transparent 2px)`, backgroundSize: "30px 30px", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", borderLeft: "1px solid rgba(255, 255, 255, 0.05)", overflowY: "auto" }}>
      <div style={{ fontSize: "64px", animation: "floatIcon 3s ease-in-out infinite", marginBottom: "12px" }}>💬</div>
      <div style={{ fontSize: "26px", fontWeight: "800", background: "linear-gradient(135deg, #8b5cf6, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: "6px" }}>SecureChat</div>
      <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.5)", marginBottom: "8px" }}>India ka most secure messaging platform</div>

      {/* Online Users Badge */}
      <div style={{ display: "flex", gap: "12px", marginBottom: "28px", flexWrap: "wrap", justifyContent: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.25)", borderRadius: "20px", padding: "5px 14px", fontSize: "12px", color: "#86efac", fontWeight: "600" }}>
          <span style={{ width: "7px", height: "7px", borderRadius: "50%", background: "#22c55e", display: "inline-block", animation: "onlinePulse 2s infinite" }} /> {onlineCount} Online
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.25)", borderRadius: "20px", padding: "5px 14px", fontSize: "12px", color: "#c4b5fd", fontWeight: "600" }}>
          🔒 E2E Encrypted
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", width: "100%", maxWidth: "500px" }}>
        {features.map((f, i) => (
          <div key={i} style={{ background: "rgba(255,255,255,0.04)", border: `1px solid ${f.color}22`, borderRadius: "16px", padding: "16px 14px", animation: `featureCardIn 0.5s ease forwards`, animationDelay: `${i * 0.07}s`, opacity: 0 }}>
      ...
      <div style={{ marginTop: "24px", fontSize: "12px", color: "rgba(255,255,255,0.3)", textAlign: "center" }}>
        ← Left mein se kisi user ko select karo chat karne ke liye
      </div>
    </div>
  );
};
...
export default function Chat({ user, onLogout }) {
  ...
  useEffect(() => {
    ...
    socket.onmessage = (e) => { const data = JSON.parse(e.data); setMessages(prev => [...prev, { sender: data.sender, message: data.message, mine: false, timestamp: new Date().toISOString() }]); };
    setWs(socket);
    return () => socket.close();
  }, [user.token]);
  ...
  const sendMessage = () => {
    ...
    setMessages(prev => [...prev, { sender: user.username, message: newMsg, mine: true, timestamp: new Date().toISOString() }]);
  ...
  const sendSticker = (sticker) => {
    ...
    setMessages(prev => [...prev, { sender: user.username, message: sticker, mine: true, isSticker: true, timestamp: new Date().toISOString() }]);
  ...
  return (
    <>
      ...
      <div style={s.app}>
        ...
        {showEnrollModal && (
          <div style={s.modalOverlay}>
            <div style={s.modalContent}>
              <button style={s.modalClose} onClick={() => setShowEnrollModal(false)}>×</button>
        ...
        {showCallModal && (
          <div style={s.modalOverlay} onClick={() => setShowCallModal(null)}>
            <div style={s.callModal} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={s.callModalSub}>{showCallModal === "voice" ? "🎙️ Voice Calling..." : "📹 Video Calling..."}</div>
        ...
        <div style={s.sidebar}>
          <div style={s.sidebarHeader}>
            ...
            <div style={s.encBadge}>
              <Icons.Lock /> End-to-End Encrypted · {onlineCount} online
            </div>
          ...
          <div style={s.userList}>
            <div style={s.userListHeader}>💬 Conversations</div>
            ...
            {users.map((u, i) => (
              <div key={u.username} style={{...(selectedUser?.username === u.username ? s.userItemActive : s.userItem), animation: `slideInLeft 0.4s ease forwards`, animationDelay: `${i * 0.05}s`, opacity: 0}} onClick={() => setSelectedUser(u)}>
                <div style={s.avatar}>
                  ...
                  {u.online && <div style={s.avatarOnlineDot} />}
                </div>
                <div style={s.userMeta}>
                  <div style={s.userName}>{u.username}</div>
                  <div style={s.userLastMsg}>{u.online ? "🟢 Online" : "⚫ Offline"}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* ── CHAT AREA ── */}
        {!selectedUser ? (
          <NoChat onlineCount={onlineCount} />
        ) : (
          <div style={s.chatArea}>
            {/* Chat Header */}
            <div style={s.chatHeader}>
              <div style={s.chatHeaderInfo}>
                <div style={{ ...s.avatar, width: "42px", height: "42px", fontSize: "16px", borderRadius: "12px", position: "relative" }}>
                  {selectedUser.username[0].toUpperCase()}
                  {selectedUser.online && <div style={{...s.avatarOnlineDot, width: "10px", height: "10px"}} />}
                </div>
                <div>
                  <div style={s.chatHeaderName}>{selectedUser.username}</div>
                  {selectedUser.online
                    ? <div style={s.chatHeaderSub}><span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "#22c55e", display: "inline-block" }} /> Online</div>
                    : <div style={s.chatHeaderSubOffline}>Last seen recently</div>
                  }
                </div>
                <div style={{ marginLeft: "4px" }}>
                  <div style={s.encBadgeSmall}><Icons.Lock /> Encrypted</div>
                </div>
              </div>
            ...
            <div style={s.messages} ref={messagesContainerRef}>
              {messages.length === 0 && (
                <div style={s.emptyChat}>
                  ...
                  <div style={s.emptyChatTitle}>Say Hi to {selectedUser.username}!</div>
                  <div style={s.emptyChatSub}>Ab baat karo — messages end-to-end encrypted hain 🔒</div>
                </div>
              )}
              {messages.map((m, i) => {
                // Date separator
                const showDate = i === 0 || !isSameDay(messages[i-1].timestamp, m.timestamp);
                const dateLabel = showDate ? getDateLabel(m.timestamp) : null;
                const isStickerMsg = isSticker(m.message) || m.isSticker;
                ...
                return (
                  <React.Fragment key={i}>
                    ...
                    <div style={s.msgWrapper(m.mine)}>
                      {!m.mine && !isStickerMsg && <div style={s.msgSender}>{m.sender}</div>}
                      <div style={{...(m.mine ? s.msgSent : s.msgReceived), ...(isStickerMsg ? s.msgSticker : {}), animationDelay: `${i * 0.02}s`}}>
                        {m.message}
                        {!isStickerMsg && (
                          <div style={s.msgMeta}>
                            <span style={s.msgTime}>{formatTime(m.timestamp)}</span>
                            {m.mine && (
                              <span style={s.msgTicksDelivered} title="Delivered">✓✓</span>
                            )}
                          </div>
                        )}
                      </div>
